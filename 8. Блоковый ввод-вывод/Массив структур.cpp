...
void print(int array_length) {
	...
	if (array_length == 0)
		...
		for (int i = 0; i < array_length; i++) {
			...
			cout << "Имя режиссёра: " << films[i].director << endl;
...

{
	...
	cout << "Удаление фильмов: \n";

	cout << "Введите заданную стоимость, не выше которой должен быть филь: ";
	...
	cout << "Содержимое базы данных после внесённых изменений: \n";
